export const SUPER_ADMIN: object = {
    login: 'superadmin@maks.systems',
    password: 'superadmin',
};
...
export const SYSTEM_ADMIN: object = {
    login: 'andrianaslobozheniuk+10@gmail.com',
    password: 'asdASD123',
};
