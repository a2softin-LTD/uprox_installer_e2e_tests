...
import {
    CABINET_FIRST, CABINET_SECOND, COMPANY_EMAIL_NEW,
    ...
    COMPANY_MONITORING_SERVICE_DESCRIPTION_OLD, COMPANY_MONITORING_SERVICE_EMAIL_OLD,
    COMPANY_MONITORING_SERVICE_NAME_NEW, COMPANY_MONITORING_SERVICE_NAME_OLD,
    COMPANY_MONITORING_SERVICE_PHONE_OLD, COMPANY_PHONE_NEW,
    COUNTRY_MOLDOVA, COUNTRY_MOLDOVA_SHORT, COUNTRY_UKRAINE,
    LANGUAGE_DUTCH, LANGUAGE_ENGLISH, LANGUAGE_ENGLISH_SHORT, LANGUAGE_FRENCH_SHORT, LANGUAGE_UKRAINIAN,
    SETTINGS_ALARMS_RESTORES, SETTINGS_ALLOWED, SETTINGS_ARMS_DISARM, SETTINGS_ARMS_DISARMS_ALARMS_RESTORES, SETTINGS_DENIED,
    TEXT_ADD_LOCALIZATION, TEXT_DELETE, TEXT_ENTER_THE_LINK,
    TITLE_COMPANY_SETTINGS, TITLE_COMPANY_SETTINGS_FRENCH, URL_LOGIN, URL_PANELS
