...
test.describe('Login Page tests', () => {
    ...
    test.describe('--Checking CRUD Admin of Company', () => {
    ...
    test.describe('--Checking authorization with different roles.', () => {
        ...
        test('positive: __--Checking auth with Role = SUPER_ADMIN', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = CORP_ADMIN', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = SYSTEM_ADMIN', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = INSTALLER', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = SUPPORT', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = MIXED', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = MONITORING_SERVICE_COMPANY_1', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = MONITORING_SERVICE_COMPANY_2', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = MONITORING_COMPANY', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = ENGINEER', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = USER_1', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
        ...
        test('positive: __Checking auth with Role = USER_2', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
                description: ""
            });
    ...
    test.describe('Checking authorization. Other scenarios _Positive scenarios', () => {
    ...
    test.describe('_Checking authorization flow. Negative scenarios', () => {

        test('negative: _Checking auth with UNKNOWN_EMAIL', async ({ page }) => {
            test.info().annotations.push({
                type: "clickUp_link",
        ...
        test('negative: _Checking auth with INVALID_EMAIL (without domain)', async ({ page }) => {
            test.info().annotations.push({
                type: "clickUp_link",
                description: "https://app.clickup.com/t/86946uqk6"
            });
        ...
        test('negative: _Checking auth with CLEARED_CREDENTIAL_FIELDS', async ({ page }) => {
            test.info().annotations.push({
                type: "clickUp_link",
                description: "https://app.clickup.com/t/86946uqk6"
            });
        ...
        test('negative: _Checking auth with EMPTY_CREDENTIAL_FIELDS', async ({ page }) => {
            test.info().annotations.push({
                type: "clickUp_link",
                description: "https://app.clickup.com/t/86946uqk6"
            });
        ...
        test('negative: _Checking auth with INVALID_PASSWORD', async ({ page }) => {
            test.info().annotations.push({
                type: 'test_id',
                description: 'https://app.clickup.com/t/86946uqk6'
            });
