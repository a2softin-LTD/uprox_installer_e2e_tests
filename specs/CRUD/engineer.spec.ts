...
test.describe('Login Page tests', () => {
    ...
    test.describe('Creation of the Security Company Admin under the different role', () => {
        ...
        test('Creation of ENGINEER under the Role = MONITORING_SERVICE_COMPANY_ADMIN', async ({ page }) => {
        ...
        test.skip('Creation of ENGINEER under the Role = CORP_ADMIN', async ({ page }) => {
            test.info().annotations.push({
                type: "test_id",
